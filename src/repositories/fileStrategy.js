...
var fs = require("fs");
var FileStrategy = /** @class */ (function () {
    /**
     * Creates a FileStrategy instance
     * @param filePath
     */
    function FileStrategy(filePath) {
     ...
     */
    FileStrategy.prototype.add = function (entity) {
     ...
     */
    FileStrategy.prototype.list = function () {
        try {
     ...
     * @returns {T} entity
     */
    FileStrategy.prototype.get = function (id) {
        try {
            return this.fileJsonData.find(function (entity) { return entity.id == id; });
        }
        catch (err) {
     ...
     * @returns {boolean} result of the operation
     */
    FileStrategy.prototype.remove = function (id) {
        try {
            var index = this.fileJsonData.findIndex(function (entity) { return entity.id = id; });
     ...
     * @param {T} entity
     */
    FileStrategy.prototype.update = function (entity) {
        try {
            var index = this.fileJsonData.findIndex(function (fileEntity) { fileEntity.id == entity.id; });
            this.fileJsonData.splice(index, 1);
            this.fileJsonData.push(entity);
            this.updateFile();
            return entity;
     ...
     * @param newContent
     */
    FileStrategy.prototype.updateFile = function () {
        try {
